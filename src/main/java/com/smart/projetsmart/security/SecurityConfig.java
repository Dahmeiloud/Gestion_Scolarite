...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.cors().and().csrf().disable()
                ...
                .requestMatchers(HttpMethod.POST, "/etudiants/*").permitAll()
                .requestMatchers(HttpMethod.POST, "/professeurs/*").permitAll()
                .requestMatchers(HttpMethod.POST, "/materiere/create").permitAll()
                .requestMatchers(HttpMethod.GET, "/materiere/create").permitAll()

                .requestMatchers(HttpMethod.POST, "/relevenotes/create").permitAll()
                .requestMatchers(HttpMethod.GET, "/relevenotes/create").permitAll()
                .requestMatchers(HttpMethod.POST, "/notes/create").permitAll()
                .requestMatchers(HttpMethod.GET, "/notes/create").permitAll()
